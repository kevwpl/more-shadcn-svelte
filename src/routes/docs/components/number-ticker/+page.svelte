...
<DocPage.Root>
	...
	<DocPage.Content>
		...
		<DocPage.Example>
			...
			<DocPage.Code
				code={`<div class="text-7xl font-bold">
  $ <NumberTicker value={52342} />
		...
		<DocPage.Text>Perfect for KPI cards to make data feel "live" and impactful.</DocPage.Text>
					...
					<div class="grid gap-4 md:grid-cols-3 w-full">
						...
						<Card.Root>
							...
							<Card.Content>
								...
								<p class="text-xs text-muted-foreground pt-1">+180 since last hour</p>
							</Card.Content>
						</Card.Root>
						...
						<Card.Root>
							...
							<Card.Content>
								...
								<p class="text-xs text-muted-foreground pt-1">Requests per second</p>
							</Card.Content>
						</Card.Root>
					</div>
				{/key}
		...
		<DocPage.Text>
			The component renders a simple <code>span</code> so it inherits font size, color, and weight
			from its parent or the <code>class</code> prop.
		</DocPage.Text>
				...
				{#key uniqueKey}
					<div class="grid grid-cols-1 md:grid-cols-2 gap-8 text-center">
						...
						<div>
							...
							<div
								class="font-mono text-4xl bg-zinc-900 text-green-400 p-4 rounded-md inline-block"
							>
