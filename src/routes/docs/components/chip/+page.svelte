...
<DocPage.Root>
	...
	<DocPage.Content>
		...
		<DocPage.Text
			>Use the `active` prop with `variant="outline"` to create toggle filters.</DocPage.Text
		>
		<DocPage.Example>
			<DocPage.Preview class="py-10">
				<Chip.Group>
		...
		<DocPage.Example>
			<DocPage.Preview class="py-10">
				<Chip.Group>
					...
					<Chip.Root variant="secondary" removable onremove={() => alert('Remove')}
						>Svelte</Chip.Root
					>
			...
			<DocPage.Code
				code={`<Chip.Root removable onremove={handleRemove}>
  React
</Chip.Root>`}
			/>
		</DocPage.Example>
