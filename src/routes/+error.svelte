...
<DocPage.Root>
    <DocPage.Header>
        ...
        <DocPage.Description>
            A collection of high-quality, copy-paste components for Svelte 5, built on top of <Link href="https://shadcn-svelte.com/" target="_blank">shadcn-svelte</Link>.
        </DocPage.Description>
    </DocPage.Header>
    ...
    <DocPage.Content>
        ...
        <div class="flex flex-col gap-4 py-4">
            ...
            <div class="flex items-center gap-4 pt-2">
                <Button href="/components/stepper">
                    Browse Components
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
            <SpotlightCard class="p-6 flex flex-col gap-2" size={300}>
                <div class="h-10 w-10 rounded-lg bg-primary/10 flex items-center justify-center text-primary mb-2">
